 ...
 */
export function registerPermissionCommands(handler: CommandHandler, permissions: Permissions): void {

  handler.registerCommand('adduser', {
    flags: '+n',
  ...
  handler.registerCommand('deluser', {
    flags: '+n',
